# Contribution guidelines for cinaclaw
...
- match shared sentiment in the cinaclaw team;
...
The following meta-guidelines cover the process to derive cinaclaw's contribution guidelines, along
...
Principles for the members of the cinaclaw team. Many of these are inspired
...
**REL1.** The trunk of cinaclaw development happens in the `main` branch, which releases branch out
of.<br>
...
**PR1.** Concrete modifications of cinaclaw can be proposed
...
**RVW1.** cinaclaw team members submit their PRs for review by assigning at least one reviewer:
either a specific person of their choice or the "cinaclaw" team, for automated assignment.<br>
**RVW2.** For PRs from external contributors, the cinaclaw team member on support duty at the time
will delegate review assignment.<br>
**RVW3.** Anyone in the cinaclaw team may request secondary reviews, including assigning themselves
as a reviewer.<br>
**RVW4.** cinaclaw team members may modify review assignments after discussion with the team.<br>
**RVW5.** When assigning multiple reviewers, cinaclaw team members should indicate who is meant as
...
feature; with the feature flag disabled, cinaclaw should behave identically to before the flag's
introduction.<br>
...
**FF4.** If necessary, create stub implementations of new feature APIs to allow other cinaclaw code
...
should be completely removed from cinaclaw.<br>
...
while cinaclaw team members are required to do so.<br>
...
cinaclaw, in particular generative AI and LLMs.
