...
template <>
struct fmt::formatter<cinaclaw::VirtualMachine::State, char> : fmt::formatter<string_view>
{
    template <typename FormatContext>
    auto format(cinaclaw::VirtualMachine::State state, FormatContext& ctx) const
    {
        std::string_view v = "(undefined)";
        switch (state)
        {
        case cinaclaw::VirtualMachine::State::off:
            v = "off";
            break;
        case cinaclaw::VirtualMachine::State::stopped:
            v = "stopped";
            break;
        case cinaclaw::VirtualMachine::State::starting:
            v = "starting";
            break;
        case cinaclaw::VirtualMachine::State::restarting:
            v = "restarting";
            break;
        case cinaclaw::VirtualMachine::State::running:
            v = "running";
            break;
        case cinaclaw::VirtualMachine::State::delayed_shutdown:
            v = "delayed_shutdown";
            break;
        case cinaclaw::VirtualMachine::State::suspending:
            v = "suspending";
            break;
        case cinaclaw::VirtualMachine::State::suspended:
            v = "suspended";
            break;
        case cinaclaw::VirtualMachine::State::unknown:
            v = "unknown";
            break;
        }
