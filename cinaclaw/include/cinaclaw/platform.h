...
#include <cinaclaw/process/process.h>
#include <cinaclaw/process/process_spec.h>
#include <cinaclaw/settings/setting_spec.h>
#include <cinaclaw/singleton.h>
#include <cinaclaw/sshfs_server_config.h>
...
#define MP_PLATFORM cinaclaw::platform::Platform::instance()
...
public:
    ...
    virtual QString cinaclaw_storage_location() const;
...
inline cinaclaw::platform::Platform::Platform(const PrivatePass& pass) noexcept : Singleton(pass)
{
}

inline std::filesystem::path cinaclaw::platform::Platform::get_root_cert_path() const
{
    constexpr auto* root_cert_file_name = "cinaclaw_root_cert.pem";
