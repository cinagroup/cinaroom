...
namespace cinaclaw
{
constexpr auto client_name = "cinaclaw";
constexpr auto daemon_name = "cinaclawd";
...
constexpr auto cinaclaw_storage_env_var = "CINACLAWS_STORAGE";
constexpr auto driver_env_var = "CINACLAWS_VM_DRIVER";
constexpr auto distributions_url_env_var = "CINACLAWS_DISTRIBUTIONS_URL";
