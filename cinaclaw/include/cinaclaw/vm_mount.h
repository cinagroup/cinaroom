...
inline const cinaclaw::id_mappings& VMMount::get_gid_mappings() const noexcept
{
    return gid_mappings;
}

inline const cinaclaw::id_mappings& VMMount::get_uid_mappings() const noexcept
{
    return uid_mappings;
}
...
{
template <>
struct formatter<cinaclaw::VMMount::MountType> : formatter<int>
{
    template <typename FormatContext>
    auto format(const cinaclaw::VMMount::MountType& mount_type, FormatContext& ctx) const
    {
