...
#define MP_CLIENT_PLATFORM cinaclaw::cli::platform::Platform::instance()
...
int getuid();
int getgid();
void open_cinaclaw_shell(
    const QString& instance_name); // precondition: requires a valid instance name
} // namespace platform
} // namespace cli
} // namespace cinaclaw

inline cinaclaw::cli::platform::Platform::Platform(const PrivatePass& pass) noexcept
    : Singleton(pass)
{
}
