...
from cli.cinaclaw import get_cinaclaw_path
...
def spawn_cinaclaw(
    ...
    """Spawn a cinaclaw process with platform-appropriate backend.

    Args:
        args: Arguments to pass to cinaclaw.
    ...
    if sys.platform == "win32":
        if interactive:
            return WinptySpawn(
                [get_cinaclaw_path(), *map(str, args)],
                # For UTF-8
