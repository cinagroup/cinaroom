...
class TestSnapshot:
    ...
    def test_take_snapshot_of_nonexistent_instance(self):
        ...
        name = random_vm_name()
        assert f'instance "{name}" does not exist' in cinaclaw(
            "snapshot", f"{name}")
    ...
    def test_take_snapshot_name_conflict(self, instance):
        ...
        with cinaclaw("snapshot", instance, "--name", "snapshot1") as result:
            assert not result
    ...
    def test_snapshot_restore_while_running(self, instance):
        ...
        assert cinaclaw("start", instance)
        assert state(instance) == "Running"

        with cinaclaw("restore", f"{instance}.snapshot1") as result:
            assert not result
            assert (
    ...
    def test_take_snapshot_delete_linear_history(self, instance):
        ...
        assert cinaclaw("delete", f"{instance}.snapshot1", "--purge")
        assert snapshot_count(instance) == 2
    ...
    def test_take_snapshot_and_restore_linear(self, instance):
        ...
        assert cinaclaw("restore", f"{instance}.snapshot1", "--destructive")
        assert snapshot_count(instance) == 3
        ...
        assert cinaclaw("stop", instance)

        assert cinaclaw("restore", f"{instance}.snapshot2", "--destructive")
        assert snapshot_count(instance) == 3
        ...
        assert cinaclaw("restore", f"{instance}.snapshot3", "--destructive")
        assert snapshot_count(instance) == 3
    ...
    def test_take_snapshot_and_restore_branched(self, instance):
        ...
        assert cinaclaw("restore", f"{instance}.snapshot2a", "--destructive")
        assert snapshot_count(instance) == 3
    ...
    def test_take_snapshot_delete_branched(self, instance):
        ...
        assert cinaclaw("restore", f"{instance}.snapshot5b", "--destructive")
        ...
        assert cinaclaw("delete", f"{instance}.snapshot4b", "--purge")
        ...
        assert cinaclaw("delete", f"{instance}.snapshot2a", "--purge")
        ...
        assert cinaclaw("delete", f"{instance}.snapshot2b", "--purge")
        assert snapshot_count(instance) == 5
    ...
    def test_take_snapshot_name_tbd(self, instance):
        ...
        assert cinaclaw("delete", f"{instance}.snapshot2", "--purge")
        ...
        assert cinaclaw("stop", instance)
        assert cinaclaw("restore", f"{instance}.snapshot0", "--destructive")
        ...
        assert cinaclaw("stop", instance)
        assert cinaclaw("restore", f"{instance}.snapshot1b", "--destructive")
        assert list_directory(
        ...
        assert cinaclaw("stop", instance)
        assert cinaclaw("restore", f"{instance}.snapshot2b", "--destructive")
        assert list_directory(
