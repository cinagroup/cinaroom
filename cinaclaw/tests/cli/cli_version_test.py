...
class TestVersion:
    ...
    def test_version_no_daemon(self, cinaclawd):
        cinaclawd.stop()
        with cinaclaw("version") as output:
            assert output
            matches = re.findall(
            ...
            assert matches[0][0] == "cinaclaw"

    def test_version_with_daemon(self, cinaclawd):
        with cinaclaw("version") as output:
            assert output
