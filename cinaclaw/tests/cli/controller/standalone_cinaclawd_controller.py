...
from cli.utilities import send_ctrl_c, get_sudo_tool
from cli.cinaclaw import get_cinaclaw_env, get_cinaclawd_path


class StandaloneMultipassdController:
    def __init__(self, data_root):
        if not get_cinaclawd_path():
            raise FileNotFoundError("Could not find 'cinaclawd' executable!")
        ...
        if sys.platform == "win32":
            ...
            prologue = [*get_sudo_tool(), "env", f"CINACLAWS_STORAGE={data_root}"]
