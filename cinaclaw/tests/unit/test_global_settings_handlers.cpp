...
struct TestGlobalSettingsHandlers : public Test
{
    ...
    static std::unique_ptr<cinaclaw::WrappedQSettings> make_default_returning_mock_qsettings(
...
TEST_F(TestGlobalSettingsHandlers, clientsRegisterPersistentHandlerWithClientFilename)
{
    ...
    auto expected_filename = config_location + "/cinaclaw/cinaclaw.conf";
...
{
    auto config_location = QStringLiteral("/a/b/c");
    auto expected_filename = config_location + "/cinaclawd.conf";
