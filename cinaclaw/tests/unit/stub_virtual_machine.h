...
namespace test
{
struct StubVirtualMachine final : public cinaclaw::VirtualMachine
{
    ...
    cinaclaw::VirtualMachine::State current_state() override
    {
        return cinaclaw::VirtualMachine::State::off;
    }
