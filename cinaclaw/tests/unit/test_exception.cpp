...
#include <cinaclaw/exceptions/formatted_exception_base.h>
...
template <typename T>
struct MockException : cinaclaw::FormattedExceptionBase<T>
{
    using cinaclaw::FormattedExceptionBase<T>::FormattedExceptionBase;
};
...
{
    MP_EXPECT_THROW_THAT(throw cinaclaw::FormattedExceptionBase<>("message {}", 1),
                         std::runtime_error,
