...
write_files:
  - path: /etc/pollinate/add-user-agent
    content: "cinaclaw/version/1.14.0-dev.1209+g5b2c7f7d # written by Multipass\ncinaclaw/driver/qemu-8.0.4 # written by Multipass\ncinaclaw/host/ubuntu-23.10 # written by Multipass\ncinaclaw/alias/default # written by Multipass\n"
)";
    mp::CloudInitIso original_iso;
