...
#include <cinaclaw/cli/csv_formatter.h>
#include <cinaclaw/cli/json_formatter.h>
#include <cinaclaw/cli/table_formatter.h>
#include <cinaclaw/cli/yaml_formatter.h>
...
auto construct_version_info_cinaclawd_update_available()
{
    ...
    reply.mutable_update_info()->set_url("http://cinaclaw.web");

    return reply;
}

auto construct_version_info_cinaclawd_up_to_date()
{
    auto reply = mp::VersionReply();
    reply.set_version("Daemon version");
...
const auto version_daemon_no_update_reply = construct_version_info_cinaclawd_up_to_date();
const auto version_daemon_update_reply = construct_version_info_cinaclawd_update_available();
