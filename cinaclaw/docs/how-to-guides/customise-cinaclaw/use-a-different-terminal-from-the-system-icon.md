(how-to-guides-customise-cinaclaw-use-a-different-terminal-from-the-system-icon)=
# Use a different terminal from the system icon

> See also: [How to install cinaclaw](how-to-guides-install-cinaclaw), [`shell`](reference-command-line-interface-shell).

If you want, you can change the terminal application used by the cinaclaw system menu icon.
...
```{figure} /images/cinaclaw-file-command-info.png
   :width: 289px
   :alt: file.command info
```

<!-- Original image on the Asset Manager
![file.command info|289x366](https://assets.ubuntu.com/v1/1ce425a9-cinaclaw-file-command-info.png)
-->
