...
> See also: [How to install cinaclaw](/how-to-guides/install-cinaclaw), [Driver](/explanation/driver)

In cinaclaw, **platform** refers to the host computer's operating system. This can be Windows, macOS, or Linux.
