...
> See also: [Configure cinaclaw’s default logging level](/how-to-guides/customise-cinaclaw/configure-cinaclaw-default-logging-level), [How to access logs](/how-to-guides/troubleshoot/access-logs)

In cinaclaw, a hierarchy of logging levels is used to convey severity and improve visibility of important events. cinaclaw uses the following levels, ranked from most severe to least severe, for its background daemon and child processes.
