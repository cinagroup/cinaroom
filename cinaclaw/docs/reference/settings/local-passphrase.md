...
Passphrase to authenticate users with the cinaclaw service, via the [`authenticate`](/reference/command-line-interface/authenticate) command.
...
Not set (expressed as `false` by `cinaclaw get`)
