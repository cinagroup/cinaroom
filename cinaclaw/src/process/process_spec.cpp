...
// Set what cinaclaw logging level the stderr of the child process should have
...
QString cinaclaw::ProcessSpec::identifier() const
{
    return QString();
}
...
const QString mp::ProcessSpec::apparmor_profile_name() const
{
    ...
    {
        return "cinaclaw." + identifier() + '.' + executable_name;
    }
    else
    {
        return "cinaclaw." + executable_name;
    }
}
