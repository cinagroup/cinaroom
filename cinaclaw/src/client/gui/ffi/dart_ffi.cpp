...
namespace mpc = cinaclaw::client;
namespace mpl = cinaclaw::logging;
namespace mcp = cinaclaw::cli::platform;
...
{
    const auto mp_storage = MP_PLATFORM.cinaclaw_storage_location();
