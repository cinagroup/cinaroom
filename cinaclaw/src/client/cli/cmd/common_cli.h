...
using RpcMethod = cinaclaw::Rpc::StubInterface;
...
// parser helpers
void add_instance_timeout(cinaclaw::ArgParser*);
void add_timeout(cinaclaw::ArgParser*);
int parse_timeout(const cinaclaw::ArgParser* parser);
std::unique_ptr<cinaclaw::utils::Timer> make_timer(int timeout,
