...
#include <cinaclaw/async_periodic_download_task.h>
#include <cinaclaw/delayed_shutdown_timer.h>
#include <cinaclaw/format.h>
#include <cinaclaw/mount_handler.h>
...
class Daemon : public QObject, public cinaclaw::VMStatusMonitor
{
    Q_OBJECT
public:
...
private:
    ...
    cinaclaw::utils::AsyncPeriodicDownloadTask<void> update_manifests_all_task{
