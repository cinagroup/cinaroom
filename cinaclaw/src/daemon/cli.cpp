...
namespace
{
cinaclaw::logging::Level to_logging_level(const QString& value)
{
...
mp::DaemonConfigBuilder mp::cli::parse(const QCoreApplication& app)
{
    ...
    parser.setApplicationDescription("cinaclaw service daemon");
    ...
    QCommandLineOption address_option{"address",
                                      "specifies which address to use for the cinaclawd service;"
