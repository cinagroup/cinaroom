...
#include <cinaclaw/client_cert_store.h>
#include <cinaclaw/constants.h>
#include <cinaclaw/image_host/custom_image_host.h>
#include <cinaclaw/image_host/image_mutators.h>
...
std::unique_ptr<const mp::DaemonConfig> mp::DaemonConfigBuilder::build()
{
    ...
    auto storage_path = MP_PLATFORM.cinaclaw_storage_location();
