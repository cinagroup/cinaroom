...
{
template <>
struct formatter<cinaclaw::applevz::CFError>
{
    ...
    auto format(const cinaclaw::applevz::CFError& e, FormatContext& ctx) const
    {
        if (!e.ref)
        ...
        std::string domain_str = cinaclaw::applevz::detail::cfstring_to_std_string(domain);
        std::string desc_str = cinaclaw::applevz::detail::cfstring_to_std_string(desc);
