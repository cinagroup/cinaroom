...
profile %1 flags=(attach_disconnected) {
  ...
  # Allow cinaclawd send qemu signals
  ...
  # access to firmware's etc (selectively chosen for cinaclaw' usage)
  %3 r,
  ...
  %8
    ...
    try
    {
        ...
        signal_peer = "snap.cinaclaw.cinaclawd"; // only cinaclawd can send qemu signals
