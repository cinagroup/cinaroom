...
private:
    virtual VirtualMachine::UPtr clone_vm_impl(const std::string& source_vm_name,
                                               const cinaclaw::VMSpecs& src_vm_specs,
...
inline void cinaclaw::BaseVirtualMachineFactory::remove_resources_for(const std::string& name)
{
...
inline cinaclaw::VirtualMachine::UPtr cinaclaw::BaseVirtualMachineFactory::clone_vm_impl(
