    ...
    : VirtualBoxVirtualMachine(desc, monitor, key_provider, dest_instance_dir, true)
{
    ...
    // because they will be overwritten by cinaclaw generated mac addresses anyway.
    mpu::process_throw_on_error("VBoxManage",
                                {"clonevm",
...
auto cinaclaw::VirtualBoxVirtualMachine::make_specific_snapshot(const QString& filename)
    -> std::shared_ptr<Snapshot>
{
    return std::make_shared<VirtualBoxSnapshot>(filename, *this, desc);
}

auto cinaclaw::VirtualBoxVirtualMachine::make_specific_snapshot(const std::string& snapshot_name,
                                                                 const std::string& comment,
                                                                 const std::string& instance_id,
                                                                 const cinaclaw::VMSpecs& specs,
