...
#include <cinaclaw/exceptions/file_open_failed_exception.h>
#include <cinaclaw/exceptions/ssh_exception.h>
...
QString mp::utils::get_cinaclaw_storage()
{
    return QString::fromUtf8(qgetenv(mp::cinaclaw_storage_env_var));
}
...
std::string mp::utils::contents_of(const cinaclaw::Path& file_path)
{
...
std::string mp::Utils::contents_of(const cinaclaw::Path& file_path) const
{
...
{
    QProcess process;
    mpl::debug(category.toStdString(),
               "Running: {}, {}",
               program.toStdString(),
    ...
    {
        mpl::debug(category.toStdString(),
                   "{} failed - errorString: {}, exitStatus: {}, exitCode: {}",
                   program.toStdString(),
