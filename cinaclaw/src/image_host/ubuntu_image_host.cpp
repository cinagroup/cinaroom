...
#include <cinaclaw/exceptions/download_exception.h>
#include <cinaclaw/exceptions/image_not_found_exception.h>
#include <cinaclaw/exceptions/manifest_exceptions.h>
#include <cinaclaw/exceptions/unsupported_image_exception.h>
#include <cinaclaw/image_host/ubuntu_image_host.h>
#include <cinaclaw/platform.h>
#include <cinaclaw/query.h>
#include <cinaclaw/settings/settings.h>
#include <cinaclaw/simple_streams_index.h>
...
mp::VMImageInfo mp::UbuntuVMImageHost::info_for_full_hash_impl(const std::string& full_hash)
{
    for (const auto& manifest : manifests)
    {
        ...
        {
            if (cinaclaw::utils::iequals(product.id.toStdString(), full_hash))
            {
                return product;
            }
        }
...
cinaclaw::UbuntuVMImageRemote::UbuntuVMImageRemote(
...
bool cinaclaw::UbuntuVMImageRemote::default_image_mutator(VMImageInfo& image)
{
    return true;
}
