...
#include "petname.h"
#include "cinaclaw/petname/names.h"
...
{
    std::string name = cinaclaw::petname::names[name_dist(engine)];
    std::string adjective = cinaclaw::petname::adjectives[adjective_dist(engine)];
    std::string adverb = cinaclaw::petname::adverbs[adverb_dist(engine)];
