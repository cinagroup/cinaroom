...
const (
	Rpc_Create_FullMethodName       = "/cinaclaw.Rpc/create"
	Rpc_Launch_FullMethodName       = "/cinaclaw.Rpc/launch"
	Rpc_Purge_FullMethodName        = "/cinaclaw.Rpc/purge"
	Rpc_Find_FullMethodName         = "/cinaclaw.Rpc/find"
	Rpc_Info_FullMethodName         = "/cinaclaw.Rpc/info"
	Rpc_List_FullMethodName         = "/cinaclaw.Rpc/list"
	Rpc_Networks_FullMethodName     = "/cinaclaw.Rpc/networks"
	Rpc_Mount_FullMethodName        = "/cinaclaw.Rpc/mount"
	Rpc_Ping_FullMethodName         = "/cinaclaw.Rpc/ping"
	Rpc_Recover_FullMethodName      = "/cinaclaw.Rpc/recover"
	Rpc_SshInfo_FullMethodName      = "/cinaclaw.Rpc/ssh_info"
	Rpc_Start_FullMethodName        = "/cinaclaw.Rpc/start"
	Rpc_Stop_FullMethodName         = "/cinaclaw.Rpc/stop"
	Rpc_Suspend_FullMethodName      = "/cinaclaw.Rpc/suspend"
	Rpc_Restart_FullMethodName      = "/cinaclaw.Rpc/restart"
	Rpc_Delet_FullMethodName        = "/cinaclaw.Rpc/delet"
	Rpc_Umount_FullMethodName       = "/cinaclaw.Rpc/umount"
	Rpc_Version_FullMethodName      = "/cinaclaw.Rpc/version"
	Rpc_Get_FullMethodName          = "/cinaclaw.Rpc/get"
	Rpc_Set_FullMethodName          = "/cinaclaw.Rpc/set"
	Rpc_Keys_FullMethodName         = "/cinaclaw.Rpc/keys"
	Rpc_Authenticate_FullMethodName = "/cinaclaw.Rpc/authenticate"
	Rpc_Snapshot_FullMethodName     = "/cinaclaw.Rpc/snapshot"
	Rpc_Restore_FullMethodName      = "/cinaclaw.Rpc/restore"
	Rpc_Clone_FullMethodName        = "/cinaclaw.Rpc/clone"
	Rpc_DaemonInfo_FullMethodName   = "/cinaclaw.Rpc/daemon_info"
	Rpc_WaitReady_FullMethodName    = "/cinaclaw.Rpc/wait_ready"
)
...
type RpcClient interface {
	...
	WaitReady(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WaitReadyRequest, WaitReadyReply], error)
}
...
func (c *rpcClient) WaitReady(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[WaitReadyRequest, WaitReadyReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Rpc_ServiceDesc.Streams[25], Rpc_WaitReady_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WaitReadyRequest, WaitReadyReply]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Rpc_WaitReadyClient = grpc.BidiStreamingClient[WaitReadyRequest, WaitReadyReply]
...
type RpcServer interface {
	...
	WaitReady(grpc.BidiStreamingServer[WaitReadyRequest, WaitReadyReply]) error
...
func (UnimplementedRpcServer) Info(grpc.BidiStreamingServer[InfoRequest, InfoReply]) error {
	return status.Error(codes.Unimplemented, "method Info not implemented")
}
...
func (UnimplementedRpcServer) Networks(grpc.BidiStreamingServer[NetworksRequest, NetworksReply]) error {
	return status.Error(codes.Unimplemented, "method Networks not implemented")
}
func (UnimplementedRpcServer) Mount(grpc.BidiStreamingServer[MountRequest, MountReply]) error {
	return status.Error(codes.Unimplemented, "method Mount not implemented")
}
...
func (UnimplementedRpcServer) Recover(grpc.BidiStreamingServer[RecoverRequest, RecoverReply]) error {
	return status.Error(codes.Unimplemented, "method Recover not implemented")
}
func (UnimplementedRpcServer) SshInfo(grpc.BidiStreamingServer[SSHInfoRequest, SSHInfoReply]) error {
	return status.Error(codes.Unimplemented, "method SshInfo not implemented")
}
...
func (UnimplementedRpcServer) DaemonInfo(grpc.BidiStreamingServer[DaemonInfoRequest, DaemonInfoReply]) error {
	return status.Error(codes.Unimplemented, "method DaemonInfo not implemented")
}
func (UnimplementedRpcServer) WaitReady(grpc.BidiStreamingServer[WaitReadyRequest, WaitReadyReply]) error {
	return status.Error(codes.Unimplemented, "method WaitReady not implemented")
}
...
func _Rpc_WaitReady_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RpcServer).WaitReady(&grpc.GenericServerStream[WaitReadyRequest, WaitReadyReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Rpc_WaitReadyServer = grpc.BidiStreamingServer[WaitReadyRequest, WaitReadyReply]

// Rpc_ServiceDesc is the grpc.ServiceDesc for Rpc service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var Rpc_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cinaclaw.Rpc",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "wait_ready",
			Handler:       _Rpc_WaitReady_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
	Metadata: "cinaclaw.proto",
}
