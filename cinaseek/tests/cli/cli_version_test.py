...
class TestVersion:
    ...
    def test_version_no_daemon(self, cinaseekd):
        cinaseekd.stop()
        with cinaseek("version") as output:
            assert output
            matches = re.findall(
            ...
            assert matches[0][0] == "cinaseek"

    def test_version_with_daemon(self, cinaseekd):
        with cinaseek("version") as output:
            assert output
