...
from cli.cinaseek import get_cinaseek_path
...
def spawn_cinaseek(
    ...
    """Spawn a cinaseek process with platform-appropriate backend.

    Args:
        args: Arguments to pass to cinaseek.
    ...
    if sys.platform == "win32":
        if interactive:
            return WinptySpawn(
                [get_cinaseek_path(), *map(str, args)],
                # For UTF-8
