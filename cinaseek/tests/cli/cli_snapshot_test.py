...
@pytest.mark.usefixtures("cinaseekd_class_scoped")
class TestSnapshot:
    """Snapshot tests."""
    ...
    def test_take_snapshot_of_nonexistent_instance(self):
        ...
        name = random_vm_name()
        assert f'instance "{name}" does not exist' in cinaseek(
            "snapshot", f"{name}")
    ...
    def test_take_snapshot_name_conflict(self, instance):
        ...
        with cinaseek("snapshot", instance, "--name", "snapshot1") as result:
            assert not result
    ...
    def test_snapshot_restore_while_running(self, instance):
        ...
        assert cinaseek("start", instance)
        assert state(instance) == "Running"

        with cinaseek("restore", f"{instance}.snapshot1") as result:
            assert not result
            assert (
    ...
    def test_take_snapshot_delete_linear_history(self, instance):
        ...
        assert cinaseek("delete", f"{instance}.snapshot1", "--purge")
        assert snapshot_count(instance) == 2
    ...
    def test_take_snapshot_and_restore_linear(self, instance):
        ...
        assert cinaseek("restore", f"{instance}.snapshot1", "--destructive")
        assert snapshot_count(instance) == 3
        ...
        assert cinaseek("stop", instance)

        assert cinaseek("restore", f"{instance}.snapshot2", "--destructive")
        assert snapshot_count(instance) == 3
        ...
        assert cinaseek("restore", f"{instance}.snapshot3", "--destructive")
        assert snapshot_count(instance) == 3
    ...
    def test_take_snapshot_and_restore_branched(self, instance):
        ...
        assert cinaseek("restore", f"{instance}.snapshot2a", "--destructive")
        assert snapshot_count(instance) == 3
    ...
    def test_take_snapshot_delete_branched(self, instance):
        ...
        assert cinaseek("restore", f"{instance}.snapshot5b", "--destructive")
        ...
        assert cinaseek("delete", f"{instance}.snapshot4b", "--purge")
        ...
        assert cinaseek("delete", f"{instance}.snapshot2a", "--purge")
        ...
        assert cinaseek("delete", f"{instance}.snapshot2b", "--purge")
        assert snapshot_count(instance) == 5
    ...
    def test_take_snapshot_name_tbd(self, instance):
        ...
        assert cinaseek("delete", f"{instance}.snapshot2", "--purge")
        ...
        assert cinaseek("stop", instance)
        assert cinaseek("restore", f"{instance}.snapshot0", "--destructive")
        ...
        assert cinaseek("stop", instance)
        assert cinaseek("restore", f"{instance}.snapshot1b", "--destructive")
        assert list_directory(
        ...
        assert cinaseek("stop", instance)
        assert cinaseek("restore", f"{instance}.snapshot2b", "--destructive")
        assert list_directory(
