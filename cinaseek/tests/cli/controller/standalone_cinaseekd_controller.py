...
from cli.cinaseek import get_cinaseek_env, get_cinaseekd_path


class StandaloneMultipassdController:
    def __init__(self, data_root):
        if not get_cinaseekd_path():
            raise FileNotFoundError("Could not find 'cinaseekd' executable!")
        ...
        if sys.platform == "win32":
            ...
            prologue = [*get_sudo_tool(), "env", f"CINASEEK_STORAGE={data_root}"]
