...
namespace test
{
struct StubVMImageVault final : public cinaseek::VMImageVault
{
    cinaseek::VMImage fetch_image(const cinaseek::FetchType&,
                                   const cinaseek::Query&,
                                   const PrepareAction& prepare,
                                   const cinaseek::ProgressMonitor&,
                                   const std::optional<std::string>&,
                                   const cinaseek::Path&) override
    {
    ...
    {
        return std::vector<std::pair<std::string, cinaseek::VMImageInfo>>{
            std::pair<std::string, cinaseek::VMImageInfo>{"default",
                                                           {{default_alias},
                                                            "Ubuntu",
                                                            "bionic",
