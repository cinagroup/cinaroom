...
#include <cinaseek/exceptions/formatted_exception_base.h>
...
template <typename T>
struct MockException : cinaseek::FormattedExceptionBase<T>
{
    using cinaseek::FormattedExceptionBase<T>::FormattedExceptionBase;
};
...
{
    MP_EXPECT_THROW_THAT(throw cinaseek::FormattedExceptionBase<>("message {}", 1),
                         std::runtime_error,
