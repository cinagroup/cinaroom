...
namespace test
{
struct StubVirtualMachine final : public cinaseek::VirtualMachine
{
    ...
    cinaseek::VirtualMachine::State current_state() override
    {
        return cinaseek::VirtualMachine::State::off;
    }
