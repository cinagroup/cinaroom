...
#include <cinaseek/cli/csv_formatter.h>
#include <cinaseek/cli/json_formatter.h>
#include <cinaseek/cli/table_formatter.h>
#include <cinaseek/cli/yaml_formatter.h>
...
auto construct_version_info_cinaseekd_update_available()
{
    ...
    reply.mutable_update_info()->set_url("http://cinaseek.web");

    return reply;
}

auto construct_version_info_cinaseekd_up_to_date()
{
    auto reply = mp::VersionReply();
    reply.set_version("Daemon version");
...
const auto version_daemon_no_update_reply = construct_version_info_cinaseekd_up_to_date();
const auto version_daemon_update_reply = construct_version_info_cinaseekd_update_available();
