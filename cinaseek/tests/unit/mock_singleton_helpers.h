...
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::mockit()
{
...
template <typename ConcreteMock, template <typename /*MockClass*/> typename MockCharacter>
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::SetUp()
{
...
template <typename ConcreteMock, template <typename /*MockClass*/> typename MockCharacter>
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::TearDown()
{
...
template <typename ConcreteMock, template <typename /*MockClass*/> typename MockCharacter>
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::register_accountant()
{
...
template <typename ConcreteMock, template <typename /*MockClass*/> typename MockCharacter>
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::release_accountant()
{
...
template <typename ConcreteMock, template <typename /*MockClass*/> typename MockCharacter>
void cinaseek::test::MockSingletonHelper<ConcreteMock, MockCharacter>::Accountant::OnTestEnd(
