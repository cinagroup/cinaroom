...
#include <cinaseek/async_periodic_download_task.h>
#include <cinaseek/delayed_shutdown_timer.h>
...
class Daemon : public QObject, public cinaseek::VMStatusMonitor
{
    Q_OBJECT
public:
...
private:
    ...
    cinaseek::utils::AsyncPeriodicDownloadTask<void> update_manifests_all_task{
