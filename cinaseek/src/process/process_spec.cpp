...
// Set what cinaseek logging level the stderr of the child process should have
...
QString cinaseek::ProcessSpec::identifier() const
{
    return QString();
}
...
const QString mp::ProcessSpec::apparmor_profile_name() const
{
    ...
    {
        return "cinaseek." + identifier() + '.' + executable_name;
    }
    else
    {
        return "cinaseek." + executable_name;
    }
}
