...
private:
    virtual VirtualMachine::UPtr clone_vm_impl(const std::string& source_vm_name,
                                               const cinaseek::VMSpecs& src_vm_specs,
...
inline void cinaseek::BaseVirtualMachineFactory::remove_resources_for(const std::string& name)
{
...
inline cinaseek::VirtualMachine::UPtr cinaseek::BaseVirtualMachineFactory::clone_vm_impl(
