...
CFError init_with_configuration(const cinaseek::VirtualMachineDescription& desc,
                                VMHandle& out_handle);
...
template <>
struct fmt::formatter<cinaseek::applevz::AppleVMState> : fmt::formatter<string_view>
{
    template <typename FormatContext>
    auto format(const cinaseek::applevz::AppleVMState& state, FormatContext& ctx) const
    {
        std::string_view v = "(undefined)";
        switch (state)
        {
        case cinaseek::applevz::AppleVMState::stopped:
            v = "stopped";
            break;
        case cinaseek::applevz::AppleVMState::running:
            v = "running";
            break;
        case cinaseek::applevz::AppleVMState::paused:
            v = "paused";
            break;
        case cinaseek::applevz::AppleVMState::error:
            v = "error";
            break;
        case cinaseek::applevz::AppleVMState::starting:
            v = "starting";
            break;
        case cinaseek::applevz::AppleVMState::pausing:
            v = "pausing";
            break;
        case cinaseek::applevz::AppleVMState::resuming:
            v = "resuming";
            break;
        case cinaseek::applevz::AppleVMState::stopping:
            v = "stopping";
            break;
        case cinaseek::applevz::AppleVMState::saving:
            v = "saving";
            break;
        case cinaseek::applevz::AppleVMState::restoring:
            v = "restoring";
            break;
        default:
            v = "unknown";
