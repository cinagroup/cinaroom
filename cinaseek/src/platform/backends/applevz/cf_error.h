...
{
template <>
struct formatter<cinaseek::applevz::CFError>
{
    ...
    auto format(const cinaseek::applevz::CFError& e, FormatContext& ctx) const
    {
        if (!e.ref)
        ...
        std::string domain_str = cinaseek::applevz::detail::cfstring_to_std_string(domain);
        std::string desc_str = cinaseek::applevz::detail::cfstring_to_std_string(desc);
