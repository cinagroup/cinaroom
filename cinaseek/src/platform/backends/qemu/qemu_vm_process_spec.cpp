...
profile %1 flags=(attach_disconnected) {
  ...
  # Allow cinaseekd send qemu signals
  ...
  # access to firmware's etc (selectively chosen for cinaseek' usage)
  %3 r,
  ...
  %8
    ...
    try
    {
        ...
        signal_peer = "snap.cinaseek.cinaseekd"; // only cinaseekd can send qemu signals
