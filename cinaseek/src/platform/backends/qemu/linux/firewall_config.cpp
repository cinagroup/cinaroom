...
auto cinaseek_firewall_comment(const QString& bridge_name)
{
...
bool kernel_supports_nftables()
{
    ...
    try
    {
        ...
        const auto kernel_supported{cinaseek::opaque_semver{kernel_version_str} >= "5.2.0"_semver};
...
mp::FirewallConfig::FirewallConfig(const QString& bridge_name, const std::string& subnet)
    : firewall{detect_firewall()},
      ...
      comment{cinaseek_firewall_comment(bridge_name)}
{
    try
    {
