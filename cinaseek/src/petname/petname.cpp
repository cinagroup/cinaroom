...
#include "petname.h"
#include "cinaseek/petname/names.h"
...
{
    std::string name = cinaseek::petname::names[name_dist(engine)];
    std::string adjective = cinaseek::petname::adjectives[adjective_dist(engine)];
    std::string adverb = cinaseek::petname::adverbs[adverb_dist(engine)];
