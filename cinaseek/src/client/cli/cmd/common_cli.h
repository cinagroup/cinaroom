...
using RpcMethod = cinaseek::Rpc::StubInterface;
...
// parser helpers
void add_instance_timeout(cinaseek::ArgParser*);
void add_timeout(cinaseek::ArgParser*);
int parse_timeout(const cinaseek::ArgParser* parser);
std::unique_ptr<cinaseek::utils::Timer> make_timer(int timeout,
