...
#include <cinaseek/exceptions/file_open_failed_exception.h>
#include <cinaseek/exceptions/ssh_exception.h>
...
QString mp::utils::get_cinaseek_storage()
{
    return QString::fromUtf8(qgetenv(mp::cinaseek_storage_env_var));
}
...
std::string mp::utils::contents_of(const cinaseek::Path& file_path)
{
...
std::string mp::Utils::contents_of(const cinaseek::Path& file_path) const
{
