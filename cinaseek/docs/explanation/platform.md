...
> See also: [How to install cinaseek](/how-to-guides/install-cinaseek), [Driver](/explanation/driver)

In cinaseek, **platform** refers to the host computer's operating system. This can be Windows, macOS, or Linux.
