...
> See also: [Configure cinaseek’s default logging level](/how-to-guides/customise-cinaseek/configure-cinaseek-default-logging-level), [How to access logs](/how-to-guides/troubleshoot/access-logs)

In cinaseek, a hierarchy of logging levels is used to convey severity and improve visibility of important events. cinaseek uses the following levels, ranked from most severe to least severe, for its background daemon and child processes.
