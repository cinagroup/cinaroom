...
Where `<instance-name>` is the name of a cinaseek instance and `<snapshot-name>` is the current name of one of its snapshots.
...
`cinaseek set local.relative-lion.snaphot2.comment="Got it! 😏"`
