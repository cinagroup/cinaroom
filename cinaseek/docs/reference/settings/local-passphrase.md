...
Passphrase to authenticate users with the cinaseek service, via the [`authenticate`](/reference/command-line-interface/authenticate) command.
...
Not set (expressed as `false` by `cinaseek get`)
