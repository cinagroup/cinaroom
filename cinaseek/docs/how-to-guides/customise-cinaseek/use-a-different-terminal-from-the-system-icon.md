(how-to-guides-customise-cinaseek-use-a-different-terminal-from-the-system-icon)=
# Use a different terminal from the system icon

> See also: [How to install cinaseek](how-to-guides-install-cinaseek), [`shell`](reference-command-line-interface-shell).

If you want, you can change the terminal application used by the cinaseek system menu icon.
...
```{figure} /images/cinaseek-file-command-info.png
   :width: 289px
   :alt: file.command info
```

<!-- Original image on the Asset Manager
![file.command info|289x366](https://assets.ubuntu.com/v1/1ce425a9-cinaseek-file-command-info.png)
-->
