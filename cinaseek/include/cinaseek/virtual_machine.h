...
template <>
struct fmt::formatter<cinaseek::VirtualMachine::State, char> : fmt::formatter<string_view>
{
    template <typename FormatContext>
    auto format(cinaseek::VirtualMachine::State state, FormatContext& ctx) const
    {
        std::string_view v = "(undefined)";
        switch (state)
        {
        case cinaseek::VirtualMachine::State::off:
            v = "off";
            break;
        case cinaseek::VirtualMachine::State::stopped:
            v = "stopped";
            break;
        case cinaseek::VirtualMachine::State::starting:
            v = "starting";
            break;
        case cinaseek::VirtualMachine::State::restarting:
            v = "restarting";
            break;
        case cinaseek::VirtualMachine::State::running:
            v = "running";
            break;
        case cinaseek::VirtualMachine::State::delayed_shutdown:
            v = "delayed_shutdown";
            break;
        case cinaseek::VirtualMachine::State::suspending:
            v = "suspending";
            break;
        case cinaseek::VirtualMachine::State::suspended:
            v = "suspended";
            break;
        case cinaseek::VirtualMachine::State::unknown:
            v = "unknown";
            break;
        }
