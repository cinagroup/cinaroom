...
template <>
struct formatter<cinaseek::MountInfo_MountPaths> : formatter<string_view>
{
    ...
    template <typename FormatContext>
    auto format(const cinaseek::MountInfo_MountPaths& mount_path, FormatContext& ctx) const
    {
...
template <>
struct formatter<cinaseek::MountInfo> : formatter<string_view>
{
    template <typename ParseContext>
    constexpr auto parse(ParseContext& ctx)
    {
    ...
    template <typename FormatContext>
    auto format(const cinaseek::MountInfo& mount_info, FormatContext& ctx) const
    {
