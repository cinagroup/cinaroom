...
#include <cinaseek/settings/setting_spec.h>
...
#define MP_PLATFORM cinaseek::platform::Platform::instance()
...
public:
    ...
    virtual QString cinaseek_storage_location() const;
...
inline cinaseek::platform::Platform::Platform(const PrivatePass& pass) noexcept : Singleton(pass)
{
}

inline std::filesystem::path cinaseek::platform::Platform::get_root_cert_path() const
{
    constexpr auto* root_cert_file_name = "cinaseek_root_cert.pem";
