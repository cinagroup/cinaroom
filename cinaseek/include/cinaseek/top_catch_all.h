...
inline void cinaseek::detail::error(std::string_view log_category, const std::exception& e)
{
    namespace mpl = cinaseek::logging;
    mpl::error(log_category, "Caught an unhandled exception: {}", e.what());
}

inline void cinaseek::detail::error(std::string_view log_category)
{
    namespace mpl = cinaseek::logging;
...
inline auto cinaseek::top_catch_all(std::string_view log_category,
                                     T&& fallback_return,
                                     Fun&& f,
...
inline void cinaseek::top_catch_all(std::string_view log_category,
                                     Fun&& f,
                                     Args&&... args) noexcept
{
    try
