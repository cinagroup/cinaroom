...
template <typename T>
inline constexpr cinaseek::Singleton<T>::Singleton(
    const cinaseek::Singleton<T>::PrivatePass&) noexcept
{
}

template <typename T>
std::unique_ptr<std::once_flag> cinaseek::Singleton<T>::once = std::make_unique<std::once_flag>();

template <typename T>
std::unique_ptr<T> cinaseek::Singleton<T>::single = nullptr;

template <typename T>
template <typename U, typename>
inline void cinaseek::Singleton<T>::mock() noexcept(noexcept(U(Base::pass)))
{
    init<U>();
}

template <typename T>
inline T& cinaseek::Singleton<T>::instance() noexcept(noexcept(T(Base::pass)))
{
    init<T>();
    return *single;
}
...
template <typename T>
inline void cinaseek::Singleton<T>::reset() noexcept
{
...
template <typename T>
template <typename U>
inline void cinaseek::Singleton<T>::init() noexcept(noexcept(U(Base::pass)))
{
