...
inline const cinaseek::id_mappings& VMMount::get_gid_mappings() const noexcept
{
    return gid_mappings;
}

inline const cinaseek::id_mappings& VMMount::get_uid_mappings() const noexcept
{
    return uid_mappings;
}
...
{
template <>
struct formatter<cinaseek::VMMount::MountType> : formatter<int>
{
    template <typename FormatContext>
    auto format(const cinaseek::VMMount::MountType& mount_type, FormatContext& ctx) const
    {
