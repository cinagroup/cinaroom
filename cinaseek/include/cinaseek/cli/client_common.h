...
namespace cinaseek
{
const QString common_client_cert_dir{"/cinaseek-client-certificate"};
const QString client_cert_prefix{"cinaseek_cert"};
...
std::string update_notice(const cinaseek::UpdateInfo& update_info);
...
void set_logger();
void set_logger(
    cinaseek::logging::Level verbosity); // full param qualification makes sure msvc is happy
void post_setup();
