...
#define MP_CLIENT_PLATFORM cinaseek::cli::platform::Platform::instance()
...
int getuid();
int getgid();
void open_cinaseek_shell(
    const QString& instance_name); // precondition: requires a valid instance name
} // namespace platform
} // namespace cli
} // namespace cinaseek

inline cinaseek::cli::platform::Platform::Platform(const PrivatePass& pass) noexcept
    : Singleton(pass)
{
}
