...
namespace cinaseek
{
constexpr auto client_name = "cinaseek";
constexpr auto daemon_name = "cinaseekd";
...
constexpr auto cinaseek_storage_env_var = "CINASEEK_STORAGE";
constexpr auto driver_env_var = "CINASEEK_VM_DRIVER";
constexpr auto distributions_url_env_var = "CINASEEK_DISTRIBUTIONS_URL";
