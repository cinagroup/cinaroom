...
A Python package for scraping cloud distribution image information for cinaseek.

## Overview

This tool fetches metadata about the latest cloud images from various Linux distributions and outputs a JSON file for use by cinaseek.
