# Contribution guidelines for cinaseek
...
- match shared sentiment in the cinaseek team;
...
The following meta-guidelines cover the process to derive cinaseek's contribution guidelines, along
...
Principles for the members of the cinaseek team. Many of these are inspired
...
**REL1.** The trunk of cinaseek development happens in the `main` branch, which releases branch out
of.<br>
...
**PR1.** Concrete modifications of cinaseek can be proposed
...
**RVW1.** cinaseek team members submit their PRs for review by assigning at least one reviewer:
either a specific person of their choice or the "cinaseek" team, for automated assignment.<br>
**RVW2.** For PRs from external contributors, the cinaseek team member on support duty at the time
will delegate review assignment.<br>
**RVW3.** Anyone in the cinaseek team may request secondary reviews, including assigning themselves
as a reviewer.<br>
**RVW4.** cinaseek team members may modify review assignments after discussion with the team.<br>
**RVW5.** When assigning multiple reviewers, cinaseek team members should indicate who is meant as
...
feature; with the feature flag disabled, cinaseek should behave identically to before the flag's
introduction.<br>
...
**FF4.** If necessary, create stub implementations of new feature APIs to allow other cinaseek code
...
should be completely removed from cinaseek.<br>
...
while cinaseek team members are required to do so.<br>
...
cinaseek, in particular generative AI and LLMs.
